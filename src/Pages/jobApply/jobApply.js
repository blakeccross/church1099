  ...
  return (
    <SafeAreaView style={{...styles.container}}>
      <ScrollView 
        ...
        contentContainerStyle={{paddingBottom: HP(7), paddingHorizontal: WP(4)}}>
        <View style={{paddingVertical: HP(2)}}>
          <Text style={{...styles.jobTxt, textAlign: 'left'}}>{data['Job Title']}</Text>
          <Text
            style={{textAlign: 'left', marginTop: HP(0),
            color: '#333333',
            fontSize: 15}}>
